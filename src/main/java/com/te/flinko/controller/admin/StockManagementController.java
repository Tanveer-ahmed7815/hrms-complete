...
public class StockManagementController extends BaseConfigController {
	...
	public ResponseEntity<SuccessResponse> saveStockGroup(
			@RequestBody List<CompanyStockGroupDTO> companyStockGroupDTOs) {
	...
	public ResponseEntity<SuccessResponse> saveStockUnits(
			@RequestBody List<CompanyStockUnitsDTO> companyStockUnitsDTOs) {
	...
	public ResponseEntity<SuccessResponse> saveStockCategories(
			@RequestBody List<CompanyStockCategoriesDTO> companyStockCategoriesDTOs) {
