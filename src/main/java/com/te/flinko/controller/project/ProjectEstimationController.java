...
public class ProjectEstimationController extends BaseConfigController {
	...
	@PutMapping
	public ResponseEntity<SuccessResponse> updateStatus(@RequestBody UpdateProjectStatusDTO updateProjectStatusDTO) {
		String updatedStatus = projectEstimationService.updateStatus(updateProjectStatusDTO);
