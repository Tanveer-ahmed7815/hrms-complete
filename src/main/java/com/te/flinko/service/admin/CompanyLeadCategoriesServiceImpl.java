...
public class CompanyLeadCategoriesServiceImpl implements CompanyLeadCategoriesService {
	...
	public String updateLead(List<CompanyLeadCategoriesDTO> companyLeadCategoriesDtoList, Long companyId) {
		...
		if (!companyLeadCategoriesDtoList.isEmpty() && companyLeadCategoriesDtoList.get(0) != null
				&& companyLeadCategoriesDtoList.get(0).getLeadCategoryId() == null) {
			companyLeadCategoriesDtoList.add(0,  CompanyLeadCategoriesDTO.builder().leadCategoryName(CONVERTED_TO_DEAL).color("#008000").build());
		}
