...
public class HrConstants {
	...
	public static final String INTERVIEW_DETAILS_ADDED_SUCCESSFULLY = "Interview Round added successfully";
	public static final String CANDIDATE_INFORMATION_ADDED_SUCCESSFULLY = "New candidate added successfully";
	public static final String CANDIDATE_INFORMATION_UPDATED_SUCCESSFULLY ="Candidate details updated successfully";
	...
	public static final String CANDIDATE_INFORMATION_SUCCESSFULLY_DELETED = "Candidate details deleted successfully ";
