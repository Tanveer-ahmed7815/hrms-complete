...
import com.te.flinko.exception.account.ProductTypeNotAvailableException;
...
import com.te.flinko.exception.sales.NoContactPersonPresentException;
...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(ProductTypeNotAvailableException.class)
	public ResponseEntity<SuccessResponse> handleProductTypeNotAvailableException(
			ProductTypeNotAvailableException exception) {
		return new ResponseEntity<>(SuccessResponse.builder().error(true).message(exception.getMessage()).build(),
				HttpStatus.BAD_REQUEST);
	}
	
	@ExceptionHandler(TallySaasException.class)
	public ResponseEntity<SuccessResponse> handleTallySaasException(
			TallySaasException exception) {
		return new ResponseEntity<>(SuccessResponse.builder().error(true).message(exception.getMessage()).build(),
				HttpStatus.BAD_REQUEST);
	}

	@ExceptionHandler(value = FileSizeLimitExceededException.class)
	public ResponseEntity<SuccessResponse> handleFileSizeLimitExceededException(
			FileSizeLimitExceededException exception) {
		return new ResponseEntity<>(SuccessResponse.builder().error(true).message("File size not supported").build(),
				HttpStatus.BAD_REQUEST);
	}

	@ExceptionHandler(value = PaymentFailedException.class)
	public ResponseEntity<SuccessResponse> handlePaymentFailedException(PaymentFailedException exception) {
		return new ResponseEntity<>(SuccessResponse.builder().error(true).message(exception.getMessage()).build(),
				HttpStatus.BAD_REQUEST);
	}

	@ExceptionHandler(value = IllegalArgumentException.class)
	public ResponseEntity<SuccessResponse> handler(IllegalArgumentException exception) {
		return new ResponseEntity<>(SuccessResponse.builder().error(true).message(exception.getMessage()).build(),
				HttpStatus.BAD_REQUEST);
	}
	...
	public ResponseEntity<SuccessResponse> invalidInputException(InvalidInputException exception,
		...
		return new ResponseEntity<>(SuccessResponse.builder().error(true)
				.data(new String(request.getContentAsByteArray(), StandardCharsets.UTF_8))
	...
	@ExceptionHandler(value = FileSupportException.class)
	public ResponseEntity<SuccessResponse> fileSupportException(FileSupportException exception) {
		return new ResponseEntity<>(new SuccessResponse(true, exception.getMessage(), null), HttpStatus.BAD_REQUEST);
...
//	}
	...
	@ExceptionHandler(value = CompanyNamePresentException.class)
	public ResponseEntity<SuccessResponse> companyNamepresentExceptionHandler(CompanyNamePresentException exception) {

		return new ResponseEntity<>(new SuccessResponse(true, exception.getMessage(), null), HttpStatus.BAD_REQUEST);
	}

	@ExceptionHandler(value = NoLeadCategoryPresentException.class)
	public ResponseEntity<SuccessResponse> noLeadCategoryPresentExceptionHandler(
			NoLeadCategoryPresentException exception) {

		return new ResponseEntity<>(new SuccessResponse(true, exception.getMessage(), null), HttpStatus.BAD_REQUEST);
	}

	@ExceptionHandler(value = com.te.flinko.exception.sales.NoClientPresentException.class)
	public ResponseEntity<SuccessResponse> noClientPresentException(NoClientPresentException exception) {

		return new ResponseEntity<>(new SuccessResponse(true, exception.getMessage(), null), HttpStatus.BAD_REQUEST);
	}

	@ExceptionHandler(value = MaxUploadSizeExceededException.class)
	public ResponseEntity<SuccessResponse> filesSizeExceedsException(MaxUploadSizeExceededException ex) {
		return new ResponseEntity<>(new SuccessResponse(true, "File to large", null), HttpStatus.BAD_REQUEST);
	}

	@ExceptionHandler(NoContactPersonPresentException.class)
	public ResponseEntity<SuccessResponse> noContactPersonPresentExceptionHandler(
			NoContactPersonPresentException exception) {

		return new ResponseEntity<>(new SuccessResponse(true, exception.getMessage(), null), HttpStatus.BAD_REQUEST);
	}

	@ExceptionHandler(value = NoLeadPresentException.class)
	public ResponseEntity<SuccessResponse> noLeadPresentExceptionHandler(NoLeadPresentException exception) {

		return new ResponseEntity<>(new SuccessResponse(true, exception.getMessage(), null), HttpStatus.BAD_REQUEST);
	}

	@ExceptionHandler(value = NoDealPresentException.class)
	public ResponseEntity<SuccessResponse> noDealPresentExceptionHandler(NoDealPresentException exception) {

		return new ResponseEntity<>(new SuccessResponse(true, exception.getMessage(), null), HttpStatus.BAD_REQUEST);
	}

	@ExceptionHandler(DealAssociatedWithProjectException.class)
	public ResponseEntity<SuccessResponse> dealAssociatedWithProjectException(
			DealAssociatedWithProjectException exception) {

		return new ResponseEntity<>(new SuccessResponse(true, exception.getMessage(), null), HttpStatus.BAD_REQUEST);
	}

	@ExceptionHandler(value = SoftwareAlreadyAvailableException.class)
	public ResponseEntity<SuccessResponse> softwareAlreadyAvailableException(
			SoftwareAlreadyAvailableException emptyException) {
		return new ResponseEntity<>(new SuccessResponse(true, emptyException.getMessage(), null),
				HttpStatus.BAD_REQUEST);
	...
	@ExceptionHandler(value = EmployeeAlreadyMappedToProjectException.class)
	public ResponseEntity<SuccessResponse> employeeNotActiveException(
			EmployeeAlreadyMappedToProjectException employeeAlreadyMappedToProjectException) {
		return new ResponseEntity<>(
				new SuccessResponse(true, employeeAlreadyMappedToProjectException.getMessage(), null),
				HttpStatus.BAD_REQUEST);

	}

	@ExceptionHandler(value = SubjectNotUniqueException.class)
	public ResponseEntity<SuccessResponse> subjectNotUniqueExceptionException(
			SubjectNotUniqueException subjectNotUniqueException) {
		return new ResponseEntity<>(new SuccessResponse(true, subjectNotUniqueException.getMessage(), null),
				HttpStatus.BAD_REQUEST);

	}
	
	@ExceptionHandler(NullPointerException.class)
	public ResponseEntity<SuccessResponse> nullPointerException(NullPointerException ex) {
		return new ResponseEntity<>(new SuccessResponse(true, ex.getMessage(), null), HttpStatus.BAD_REQUEST);
	}

	@ExceptionHandler(value = VendorAlreadyExistException.class)
	public ResponseEntity<SuccessResponse> vendorAlreadyExistException(
			SubjectNotUniqueException vendorAlreadyExistException) {
		return new ResponseEntity<>(new SuccessResponse(true, vendorAlreadyExistException.getMessage(), null),
				HttpStatus.BAD_REQUEST);

	}
	
	@ExceptionHandler(PushNotificationException.class)
	public ResponseEntity<SuccessResponse> pushNotificationExceptionException(
	...
	public ResponseEntity<SuccessResponse> invalidTokenExceptionException(
	...
	public ResponseEntity<SuccessResponse> exception(Exception ex) {
		return new ResponseEntity<>(new SuccessResponse(true, ex.getMessage(), null), HttpStatus.BAD_REQUEST);
	}
