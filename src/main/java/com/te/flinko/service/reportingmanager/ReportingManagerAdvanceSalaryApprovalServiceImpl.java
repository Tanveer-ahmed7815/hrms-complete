				...
				.map(employeeAdvanceSalary -> {
					return optional
							...
							.map(r -> {
								...
								notificationServiceImpl.saveNotification("Advance salary request for the amount "+employeeAdvanceSalary.getAmount()+" is Rejected by Reporting Manager",
								...
								if (employeeAdvanceSalary.getEmployeePersonalInfo().getExpoToken() != null) {
									pushNotificationService.pushMessage("Flinko","Advance salary request for the amount "+employeeAdvanceSalary.getAmount()+" is Rejected by Reporting Manager",
											employeeAdvanceSalary.getEmployeePersonalInfo().getExpoToken());
									}
								
								return "Advance salary Rejected successfully";
							})
							.orElseGet(() -> optional.filter(
									...
									.map(a -> {
										...
										notificationServiceImpl.saveNotification("Advance salary request for the amount "+employeeAdvanceSalary.getAmount()+" is Approved by Reporting Manager",
												employeeAdvanceSalary.getEmployeePersonalInfo().getEmployeeInfoId());
										
										if (employeeAdvanceSalary.getEmployeePersonalInfo().getExpoToken() != null) {
											pushNotificationService.pushMessage("Flinko","Advance salary request for the amount "+employeeAdvanceSalary.getAmount()+" is Approved by Reporting Manager",
													employeeAdvanceSalary.getEmployeePersonalInfo().getExpoToken());
											}
										
										return "Advance salary approved successfully";
