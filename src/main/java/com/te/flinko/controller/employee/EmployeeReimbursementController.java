...
public class EmployeeReimbursementController extends BaseConfigController {
	...
	public ResponseEntity<SuccessResponse> getReimbursementDTOList(@PathVariable Long employeeInfoId,
			@PathVariable String status) {

		List<EmployeeReimbursementDTO> reimbursementDTOList = service.getReimbursementDTOList(employeeInfoId,
				getCompanyId(), status);
